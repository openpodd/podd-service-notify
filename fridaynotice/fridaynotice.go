...
var messages = []string {
	"สวัสดีค่ะ พื้นที่ของคุณมีเหตุผิดปกติบ้างหรือไม่? ถ้าไม่พบเหตุการณ์ผิดปกติ กรุณาส่งรายงานไม่พบเหตุการณ์ผิดปกติมายังโครงการผ่อดีดีด้วยนะคะ",
	"วันนี้อาสาผ่อดีดีพบเหตุการณ์ผิดปกติหรือไม่? ถ้าไม่พบเหตุการณ์ผิดปกติ กรุณาส่งรายงานไม่พบเหตุการณ์ผิดปกติมายังโครงการผ่อดีดีด้วยนะคะ",
}
